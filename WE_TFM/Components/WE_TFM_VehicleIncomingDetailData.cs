...
namespace WE_TFM.Components
{
    public struct WE_TFM_VehicleIncomingDetailData : IComponentData, ISerializable
    {
        ...
        public WE_TFM_VehicleIncomingDetailData(VehicleStatusDescription title, VehicleStatusDescription subtitle, ushort distanceHm, uint frame) : this()
        {
            this.title = title;
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            {
                throw new System.Exception($"Unsupported version {version} for {nameof(WE_TFM_VehicleIncomingDetailData)}. Current version is {CURRENT_VERSION}.");
            }
        ...
        public readonly bool IsValid() => cacheFrame == WE_TFM_IncomingVehicleSystem.Instance.CurrentFrame;
