...
namespace WE_TFM.Components
{
    public struct WE_TFM_WaypointDestinationConnections : IBufferElementData, ISerializable, IEquatable<WE_TFM_WaypointDestinationConnections>
    {
        ...
        public override bool Equals(object obj) => obj is WE_TFM_WaypointDestinationConnections connections && Equals(connections);

        public bool Equals(WE_TFM_WaypointDestinationConnections other) => line.Equals(other.line);

        public override readonly int GetHashCode() => HashCode.Combine(line);

        public static bool operator ==(WE_TFM_WaypointDestinationConnections left, WE_TFM_WaypointDestinationConnections right) => left.Equals(right);

        public static bool operator !=(WE_TFM_WaypointDestinationConnections left, WE_TFM_WaypointDestinationConnections right) => !(left == right);
    }
}
